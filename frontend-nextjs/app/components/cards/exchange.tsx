    ...
    <div className="bg-white rounded-xl shadow-2xs font-inter border border-neutral-200 p-2.5 flex flex-col gap-2.5 h-full w-full">
      ...
      <div className="rounded-xl border border-neutral-200 bg-white overflow-hidden w-full">
        ...
        <div className="px-3 py-2 text-center">
          <p className="text-lg font-medium text-neutral-900">$100.00</p>
        ...
        <div className="border-t border-neutral-200 px-3 py-1 bg-gray-200 text-center item-center justify-center flex text-xs text-neutral-600">
      ...
      {/* Exchange Button */}
      <button className="mt-1 w-full border rounded-md py-1.5 flex items-center justify-center gap-1.5 text-neutral-700 hover:bg-neutral-50 transition text-xs">
